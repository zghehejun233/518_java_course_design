...
#### 教研活动模块
- 社会实践(practice)：实践名称、内容、负责人、组织机构、地点、时间
- 学科竞赛(competition)：竞赛名称、竞赛类型、主办方、奖项名称、时间
- 科技成果(scitificResult)：成果名称、简介、作者、级别、时间
- 培训讲座(lecture)：主题、主讲人、内容、地点、时间
- 创新项目(innovationProject)：名称、简介、负责人、指导、挂靠组织、备注
- 校外实习(internship)：实习机构、工作内容、地点、开始时间、结束时间

#### 课程模块
- 开设课程管理(Course): 课程名称、课程号、授课老师、学分、开始、结束、循环、_材料、时间、选课、作业、成绩、考勤_
- 选课信息(CourseSelection): 类型（必修/选修）
- 作业信息(Homework): 内容、得分
- 成绩信息(Score): 成绩、计分方式、平时成绩、期末成绩
- 考勤信息(Checkout): 方式、是否成功、_课程时间_
- 参考材料(Reference): 类型、语言、作者、详情、_课程_
- 课程时间(CourseTime): 周几、第几节课、_课程_、_考勤_

#### 日常信息模块
- 活动信息(Activity): 名称、负责人、内容、地点、时间
- 校外活动信息(outing): 名称、内容、地点、时间
- 请假信息(leave): 原因、是否同意、类型、时间
- 消费信息(cost): 金额、备注、时间
- 荣誉信息(achievement): 名称、级别、内容、授予人、时间
